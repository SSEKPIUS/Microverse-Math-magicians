...
describe('Math Magicians: tests', () => {
  ...
  describe('operate.js test', () => {
    test('AC', () => {
      expect(calculate({ total: null, next: null, operation: null }, 'AC')).toMatchObject({ total: null, next: null, operation: null });
    });
    test('Addition', () => {
      expect(calculate({ total: 4, next: 2, operation: '+' }, '=')).toMatchObject({ total: '6', next: null, operation: null });
    });
    test('Subtraction', () => {
      expect(calculate({ total: 4, next: 2, operation: '-' }, '=')).toMatchObject({ total: '2', next: null, operation: null });
    });
  });
